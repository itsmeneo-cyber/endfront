...
// import { Box, CircularProgress, List, ListItem, ListItemAvatar, Avatar, ListItemText, ListItemSecondaryAction, IconButton, Tooltip, Badge, Paper } from "@mui/material";
// import { Chat as ChatIcon, Notifications as NotificationsIcon } from "@mui/icons-material";
...
//       <List>
//         {friends.map((friend) => (
//           <Paper key={friend.uid} sx={{ mb: 2, p: 1 }}>
//             <ListItem disablePadding button onClick={() => handleStartChat(friend)}>
//               <ListItemAvatar>
//                 <Badge
//                   color="secondary"
//                   variant="dot"
...
//                 >
//                   <Avatar alt={`${friend.displayName}'s profile picture`} src={friend.photoURL} />
//                 </Badge>
//               </ListItemAvatar>
...
//                     onClick={() => handleNotificationClick(friend)}
//                   >
